...
const (
	...
	UziSrv_GetNodeSegments_FullMethodName           = "/UziSrv/getNodeSegments"
...
type UziSrvClient interface {
	...
	GetNodeSegments(ctx context.Context, in *GetNodeSegmentsIn, opts ...grpc.CallOption) (*GetNodeSegmentsOut, error)
...
func (c *uziSrvClient) GetNodeSegments(ctx context.Context, in *GetNodeSegmentsIn, opts ...grpc.CallOption) (*GetNodeSegmentsOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNodeSegmentsOut)
	err := c.cc.Invoke(ctx, UziSrv_GetNodeSegments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UziSrvServer interface {
	...
	GetNodeSegments(context.Context, *GetNodeSegmentsIn) (*GetNodeSegmentsOut, error)
...
func (UnimplementedUziSrvServer) GetNodeSegments(context.Context, *GetNodeSegmentsIn) (*GetNodeSegmentsOut, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNodeSegments not implemented")
}
...
func _UziSrv_GetNodeSegments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNodeSegmentsIn)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UziSrvServer).GetNodeSegments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UziSrv_GetNodeSegments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UziSrvServer).GetNodeSegments(ctx, req.(*GetNodeSegmentsIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UziSrv_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getNodeSegments",
			Handler:    _UziSrv_GetNodeSegments_Handler,
		},
		{
