...
import (
	...
	loginsrv "yir/auth/internal/services/login"
	passwordsrv "yir/auth/internal/services/password"
	refreshsrv "yir/auth/internal/services/refresh"
	registersrv "yir/auth/internal/services/register"
	tokenizersrv "yir/auth/internal/services/tokenizer"

	pb "yir/auth/internal/generated/grpc/service"
	grpchandler "yir/auth/internal/grpc"

	loginhadnler "yir/auth/internal/grpc/login"
	refreshhadnler "yir/auth/internal/grpc/refresh"
	registerhadnler "yir/auth/internal/grpc/register"
