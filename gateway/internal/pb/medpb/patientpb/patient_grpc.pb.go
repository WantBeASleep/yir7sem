...
type MedPatientClient interface {
	...
	PatientShots(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *medPatientClient) PatientShots(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/yir.med.MedPatient/PatientShots", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MedPatientServer interface {
	...
	//
	// Получает id пациента. Возвращает пациента, карту, снимки
	PatientShots(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
	// Обновить данные пациента
	//
	// Получает пациента, карту. Возвращает id
...
func (UnimplementedMedPatientServer) PatientShots(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PatientShots not implemented")
}
...
func _MedPatient_PatientShots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MedPatientServer).PatientShots(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yir.med.MedPatient/PatientShots",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MedPatientServer).PatientShots(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MedPatient_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PatientShots",
			Handler:    _MedPatient_PatientShots_Handler,
		},
		{
