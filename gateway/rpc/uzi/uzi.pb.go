...
type UziRequest struct {
	...
	// @gotags: json:"url"
	Url string `protobuf:"bytes,200,opt,name=url,proto3" json:"url"`
	// @gotags: json:"projection"
	Projection string `protobuf:"bytes,300,opt,name=projection,proto3" json:"projection"`
	// @gotags: json:"patient_id"
	PatientId string `protobuf:"bytes,400,opt,name=patient_id,proto3" json:"patient_id"`
	// @gotags: json:"device_id"
	DeviceId int64 `protobuf:"varint,500,opt,name=device_id,proto3" json:"device_id"`
}
